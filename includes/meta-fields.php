...
function td_project_links_box( $post ) {
    ...
    $source = get_post_meta( $post->ID, '_td_source_url', true );
    ?>
    <p>
        <label><strong>Live Demo URL</strong></label>
        <input type="url" name="td_live_url" value="<?php echo esc_attr( $live ); ?>" style="width:100%;">
    </p>

    <p>
        <label><strong>Source Code URL</strong></label>
        <input type="url" name="td_source_url" value="<?php echo esc_attr( $source ); ?>" style="width:100%;">
    </p>
    <?php
}
